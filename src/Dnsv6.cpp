...
void DNSClientv6::begin(const IP6Address& aDNSServer)
{
...
int DNSClientv6::inet_aton(const char* address, IP6Address& result)
{
...
int DNSClientv6::getHostByName(const char* aHostname, IP6Address& aResult, uint16_t timeout)
{
	int ret = 0;
...
uint16_t DNSClientv6::BuildRequest(const char* aName)
{
	// Build header
	//                                    1  1  1  1  1  1
...
uint16_t DNSClientv6::ProcessResponse(uint16_t aTimeout, IP6Address& aAddress)
{
